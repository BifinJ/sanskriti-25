...
const faqs = [
  ...
  { question: "2. When and where will Sanskriti ‘25 take place?", answer: "The festival will be held at Mar Athanasius College of Engineering (MACE), with events happening across various venues on campus. Stay tuned for the official dates!" },

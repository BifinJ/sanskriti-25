  ...
  return (
    <section className="relative w-dvw min-h-dvh flex items-center justify-center bg-gray-800">
        ...
        <div className="bg-transparent flex flex-col items-center gap-5">
          ...
          <h4 className=" px-8 py-2 text-base sm:text-xl md:text-2xl font-normal font-barlow text-secondary bg-black">Lorem ipsum dolor sit amet consectetur.</h4>
          <p className=" font-courier font-normal text-xs sm:text-sm md:text-base text-secondary">Jan 12, 2035, 9:00 AM | Conference Venue</p>
